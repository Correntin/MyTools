...
public class AllAppsAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        if (view == null)
        {
            ...
            viewHolder.textViewVersions = (TextView) view.findViewById(R.id.all_apps_fragment_list_textview_versions);
        ...
        if (i >= 0 && i < this.androidApps.size())
        {
            ...
            viewHolder.textViewVersions.setText("Code: " + androidApp.getPackageInfo().versionCode + " Name: " + androidApp.getPackageInfo().versionName);
