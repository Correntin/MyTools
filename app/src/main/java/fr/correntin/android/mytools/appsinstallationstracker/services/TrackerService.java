package fr.correntin.android.mytools.appsinstallationstracker.services;
...
import fr.correntin.android.mytools.common.utils.NotificationsUtils;
...
public class TrackerService extends Service
{
    ...
    private void handlePackageChanged(ApplicationInfo applicationInfo)
    {
        ...
        NotificationsUtils.buildAndNotifyNotification(this, applicationInfo.uid, packageManager.getApplicationLabel(applicationInfo),
                this.getString(R.string.apps_installations_tracker_title_package_changed) + " : " + applicationInfo.packageName,
                appIcon, androidDetailsAppsIntent, action);
    }
